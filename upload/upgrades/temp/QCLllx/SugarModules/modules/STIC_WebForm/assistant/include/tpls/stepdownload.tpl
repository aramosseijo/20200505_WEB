{* Muestra la pantalla con para descargar el formulario o bien con el propio formulario en formato texto *}
{literal}
<style>
	...
	<table style="width: 100%;" class="edit view">
		<tr>
			...
			<table style="width: 100%; border: 0;">
				...
				<tr>
					<b>{$MOD.LBL_WEBFORMS_LINK_DESC}&nbsp;{$MOD.LBL_WEBFORMS_NAME}
					<a href="{$MAP.LINK_TO_WEB_FORM}">{$MOD[$MAP.DOWNLOAD_LABEL]}</a></b>
				</tr>
			</table>
			</td>
		</tr>
		<tr>
			<td>
				...
				<textarea rows="6" cols="80">{$MAP.RAW_SOURCE|escape:"htmlall"}</textarea>
			</td>
		</tr>
	</table>
</form>
