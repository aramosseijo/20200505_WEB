...
{$fields.{{$displayParams.key}}_address_city.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br} {if isset($fields.{{$displayParams.key}}_address_state.options) }
{$fields.{{$displayParams.key}}_address_state.options[$fields.{{$displayParams.key}}_address_state.value]}
{else}
{$fields.{{$displayParams.key}}_address_state.value|escape:'htmlentitydecode'|strip_tags|url2html|nl2br}
{/if}&nbsp;&nbsp;{$fields.{{$displayParams.key}}_address_postalcode.value|escape:'htmlentitydecode'|strip_tags|url2html|nl2br}<br>
{if isset($fields.{{$displayParams.key}}_address_country.options) }
{$fields.{{$displayParams.key}}_address_country.options[$fields.{{$displayParams.key}}_address_country.value]}
{else}
