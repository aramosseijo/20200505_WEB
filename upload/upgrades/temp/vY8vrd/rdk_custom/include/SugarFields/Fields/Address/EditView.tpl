...
<td>
	{if isset($fields.{{$country}}.options) }
		...
		{else}
			{html_options options=$fields.{{$country}}.options selected={{sugarvar key='default' string=true}}}
		{/if}
		</select>
	{else}
