...
var modulo = "redk_Historico_Relacion_Cuentas";
...
//    ajaxStatus.hideStatus();
    ...
    if(valor_name == ''){
        ...
        var cuenta = document.getElementById('redk_historico_relacion_cuentas_accounts_name').value;
        ...
        if (cuenta !== '')
                name.value = cuenta;
            if (tiporelacion !== '')
                name.value = (cuenta === '') ? tiporelacion : cuenta + ' - ' + tiporelacion;
    }
