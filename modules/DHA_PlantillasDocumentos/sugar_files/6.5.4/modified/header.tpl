...
{{* -------------------- BEGIN HACK MAIL MERGE REPORTS (PLANTILLAS DOCUMENTOS) ------ *}}
    {{if empty($form.hideGenerateDocument) || !$form.hideGenerateDocument}}
        {{sugar_button module="$module" id="GENERATE_DOCUMENT" view="EditView" form_id="formDetailView" appendTo="detail_header_buttons"}}
    {{/if}}   
{{* -------------------- END HACK MAIL MERGE REPORTS (PLANTILLAS DOCUMENTOS) ------ *}}    
