    	...
    	<tr>
    		<td>
        		<table style="width: 100%">
        			...
        			{if $MAP.PERSISTENT_DATA.incluyefp}
        			<tr>
        				<td scope="row">{$MOD.LBL_WEBFORMS_IMPORTE}:&nbsp;</td>
        				<td>
                            <input id="importe" name="importe" size="10" value="{$MAP.FORM_IMPORTE}" type="text">
                        </td>
        			</tr>
        			<tr>
        			...
        			{* Chequear Número de identificación *}
        			<tr>
        			...
        			<tr>
        				...
        				<td>
        					<span sugar="slot40b"> 
        						...
        						<input title="{$APP.LBL_SELECT_BUTTON_TITLE}" type="button" class="button" value='{$APP.LBL_SELECT_BUTTON_LABEL}' name=btn1 onclick='open_popup("redk_Eventos", 600, 400, "", true, false,{$MAP.EVENTS_POPUP_REQ_DATA});' />
        					</span sugar="slot">
        				</td>
        			</tr>
        			<tr>
					...
					<tr>
						<td scope="row"><slot>{$MOD.LBL_WEBFORMS_ATTACHED_FILES_NUMBER}:</slot></td>
						<td>
							<slot>
