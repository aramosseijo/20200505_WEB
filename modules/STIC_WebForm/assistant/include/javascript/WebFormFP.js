/*Código de la libreria https://github.com/arhs/iban.js
...
(function (root, factory) {
    ...
    if (!Array.prototype.map) {
        Array.prototype.map = function (fun /*, thisArg */ ) {
            ...
            for (var i = 0; i < len; i++) {
                // STIC NOTE: Absolute correctness would demand Object.defineProperty
...
function validateIBAN() {
    ...
    if (document.getElementById('redk_Formas_de_Pago___mediopago').value == 'domiciliacion') {
        ...
        if (numeroCuentaEl == null) { // Si no hay número de cuenta dará error
            ...
            if (!IBAN.isValid(numeroCuentaEl.value)) {
                alert(redk_Formas_de_pago_LBL_CCC_ERRONEA);
                selectTextInput(numeroCuentaEl);
                return false;
            }
        }
    }
