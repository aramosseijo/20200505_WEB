...
*}
<link type="text/css" href="{sugar_getjspath file="custom/modules/stic_Sessions/Calendar/Cal.css"}" rel="stylesheet" />
{sugar_getscript file="custom/modules/stic_Sessions/Calendar/Cal.js"}
